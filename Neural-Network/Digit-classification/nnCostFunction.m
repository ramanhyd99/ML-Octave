...
for i=1:m,
  ...
  seg1 = y_temp' * log(a3);
  seg2 = (1-y_temp)' * log(1-a3);
  total = total + seg1 + seg2;
  
  delta3 = a3 - y_temp;
  delta2 = (Theta2' * delta3) .* (a2 .* (1-a2));
  
  delta2 = delta2(2:end,:); %remove the bias factor delta while calculating a1d2
  
  
  total_delta1 = total_delta1 + delta2*a1;
  total_detla2 = total_detla2 + delta3*a2'; 
...
Theta1_grad = (1/m)*(total_delta1 + (lambda) * Theta1_reg);
Theta2_grad = (1/m)*(total_detla2 + (lambda) * Theta2_reg);
